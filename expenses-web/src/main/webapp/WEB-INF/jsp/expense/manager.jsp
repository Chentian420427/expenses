			...
			<form id="passwordForm">
			  ...
			  <div class="form-group">
				...
				<label class="radio-inline">
				  <input type="radio" name="status" id="approvalexpensestatus" checked value="1"> 审批通过
				</label>
				<label class="radio-inline">
				  <input type="radio" name="status" id="approvalexpensestatus" value="-1"> 不通过
				</label>
			  </div>
	...
	<script src="${APP_PATH}/script/clickActive.js"></script>
        <script type="text/javascript">
			...
			function pageQuery(pn){
				...
				$.ajax({
					type: "POST",
					url: "${APP_PATH}/expense/pageQueryManager",
					data:jsonData,
					beforSend:function(){
            ...
            $("#approvalexpensesaveBtn").click(function(){
            	...
            	$.ajax({
            		type:"POST",
            		url:"${APP_PATH}/expense/approvalManager",
            		data:{
