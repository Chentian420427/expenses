			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" value="${permission.name}" id="permissionname" placeholder="请输入权限名称">
				  </div>
            ...
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		beforeSend:function(){
							loadingIndex = layer.msg('正在修改权限，请稍等', {icon: 16});
			    		},
			    		success:function(result){
			    			...
			    			if(result.success){
			    				...
			    				layer.msg("权限信息修改失败，请重新操作", {time:1000, icon:5, shift:6}, function(){
