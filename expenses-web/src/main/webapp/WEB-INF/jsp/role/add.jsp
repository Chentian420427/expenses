      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="margin-top: 20px;background:#e9ecf3">
				<ol class="breadcrumb" style="background:#e9ecf3">
				  ...
				  <li><a href="${APP_PATH}/role/index">数据列表</a></li>
			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					<label for="exampleInputPassword1">角色信息</label>
					<input type="text" class="form-control" id="rolename" placeholder="请输入角色信息">
				  </div>
            ...
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		beforeSend:function(){
							loadingIndex = layer.msg('正在添加角色，请稍等', {icon: 16});
			    		},
			    		success:function(result){
			    			...
			    			if(result.success){
			    				...
			    				layer.msg("角色信息保存失败，请重新操作", {time:1000, icon:5, shift:6}, function(){
