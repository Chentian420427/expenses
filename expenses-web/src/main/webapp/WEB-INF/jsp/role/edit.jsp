			  ...
			  <div class="panel-body">
				<form id="roleForm" role="form">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rolename" value="${role.name}" placeholder="请输入用户名称">
				  </div>
            ...
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		beforeSend:function(){
							loadingIndex = layer.msg('正在修改角色信息，请稍等', {icon: 16});
			    		},
			    		success:function(result){
			    			...
			    			if(result.success){
			    				...
			    				layer.msg("角色信息修改失败，请重新操作", {time:1000, icon:5, shift:6}, function(){
